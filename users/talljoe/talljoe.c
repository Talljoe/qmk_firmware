...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NORTRON] = TEMPLATE(
      ...
      _______, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_P   , KC_M   , KC_COMM, KC_DOT , KC_SLSH,          _______, _______,
      _______, _______, _______,                   MLT_E  , _______, _______,                   _______, _______, _______, _______),
  // Maltron and Norman finally get together.
  [_MALMAN] = TEMPLATE(
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, KC_Q   , KC_W   , KC_D   , KC_F   , KC_SCLN, KC_J   , KC_U   , KC_K   , KC_L   , KC_BSLS, _______, _______, _______,
      _______, KC_A   , KC_N   , KC_I   , KC_S   , KC_G   , KC_Y   , KC_T   , KC_H   , KC_O   , KC_R   , _______,          _______,
      _______, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_P   , KC_M   , KC_COMM, KC_DOT , KC_SLSH,          _______, _______,
      _______, _______, _______,                   MLT_E  , _______, _______,                   _______, _______, _______, _______),
#endif
  ...
  [_NAV] = TEMPLATE_NAV(
      ...
      CTL_ESC, KC_LPRN, KC_RPRN, KC_QUOT, KC_DQUO, KC_CIRC, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END , KC_BSPC,          TG_ADJ ,
      KC_LSFT, KC_EQL,  KC_PLUS, KC_MINS, KC_UNDS, KC_AMPR, KC_QUOT, US_GRV , KC_WBAK, KC_WFWD, KC_WREF,          KC_RSFT, KC_APP ,
 ...
 // Adjust layer is on the split-shift key; or NAV+Enter (for non-split keyboards)
  [_ADJUST] = TEMPLATE_ADJUST(
      ...
      TG_NKRO, LY_QWER, LY_WORK, LY_CLMK, LY_DVRK, LY_NTRN, LY_NRMN, LY_MALT, LY_MLMN, XXXXXXX, KC_MAKE,          KC_CAPS, XXXXXXX,
