...
void backlight_effect_indicators(void)
{
	...
	if ( IS_LAYER_ON_OR_DEFAULT(BACKLIGHT_MOD_LAYER_3) )
	{
	...
	else if ( IS_LAYER_ON_OR_DEFAULT(BACKLIGHT_MOD_LAYER_2) )
	{
	...
	else if ( IS_LAYER_ON_OR_DEFAULT(BACKLIGHT_MOD_LAYER_1) )
	{
